...
module.exports = {
    ...
    async execute(client, interaction) {
        ...
        // ---------------------------------------------------------
        // BOTONES (Tickets, Sorteos, Postulaciones)
        // ---------------------------------------------------------
        if (interaction.isButton()) {

            // -----------------------------------------------------
            // POSTULACIONES — BOTÓN INICIAL
            // -----------------------------------------------------
            ...
            // -----------------------------------------------------
            // BOTONES DE ACEPTAR / RECHAZAR POSTULACIONES
            // -----------------------------------------------------
        ...
        if (interaction.isModalSubmit()) {
            ...
            if (interaction.customId.startsWith("form4_")) {
                ...
                const botones = new ActionRowBuilder().addComponents(
                    ...
                    content: "✅ Postulación enviada correctamente.",
                    embeds: embeds,
                    components: [botones]
                });
